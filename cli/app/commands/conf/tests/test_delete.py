...
from app.commands.conf.delete import (
    EnvironmentManager,
    DeleteResult,
    DeleteConfig,
    DeleteService,
...
class TestDeleteService:
    ...
    def test_delete_success(self):
        ...
        assert result.success is True
        assert result.error is None
        self.logger.info.assert_called_once_with(configuration_deleted.format(
            service="api", key="TEST_KEY"
        ))
        self.environment_service.delete_config.assert_called_once_with(
            "api", "TEST_KEY", None
        )
    ...
    def test_delete_failure(self):
        ...
        self.logger.error.assert_called_once_with(configuration_delete_failed.format(
            service="api", error="Delete error"
        ))
    ...
    def test_delete_and_format_dry_run(self):
        ...
        assert dry_run_delete_config.format(
            service="api", key="TEST_KEY"
        ) in output
