...
from app.commands.service.ps import (
...
class TestDockerService:
    ...
    def test_show_services_status_success(self, mock_run):
        ...
        self.logger.info.assert_called_once_with("Psing services: web")
        self.logger.success.assert_called_once_with("Services psed successfully: web")
...
class TestPs:
    ...
    def test_ps_success(self):
        ...
        with patch("app.commands.service.ps.PsService.execute", return_value=PsResult(
            name=config.name,
