...
class TestDisplayVersion:
    ...
    @patch('core.version.version.console')
    @patch('core.version.version.version')
...
class TestVersionFunctionSignature:
    ...
    def test_display_version_returns_none(self):
        ...
        with patch('core.version.version.console'):
            with patch('core.version.version.version', return_value="1.0.0"):
